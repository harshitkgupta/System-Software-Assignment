...
class EightPuzzle {
    ...
    Queue<String> queue = new LinkedList<String>();    // Use of Queue Implemented using LinkedList for Storing All the Nodes in BFS.
...
class DOPDemo 
{
 ...
 public static void main(String args[]){
	...
	str=buffer.readLine();                                 
	 ...
	 DOP p1= new DOP(0,eightPuzzle);                                       
         DOP  p2= new DOP(1,eightPuzzle);                                     
         DOP  p3= new DOP(2,eightPuzzle);                                    
         DOP  p4= new DOP(3,eightPuzzle);
	 DOP p5= new DOP(4,eightPuzzle);                                       
         DOP  p6= new DOP(5,eightPuzzle);                                     
         DOP  p7= new DOP(6,eightPuzzle);                                     
         DOP  p8= new DOP(7,eightPuzzle); 
