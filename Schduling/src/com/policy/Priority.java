...
public class Priority {
	...
	Priority(List<Process> processList)
	{
		ganntT=new int[200];
		ganntP=new int[200];
	...
	public void printResult()
	{
		...
		System.out.println("Simulation result of Priority Schduling ");
		...
		System.out.println("Average Waiting Time of Prioity "+avgWatingTime);
		System.out.println("Average TurnAround Time of Priority "+avgTurnaroundTime);
		for(int i=0;i<j;i++)
		{
